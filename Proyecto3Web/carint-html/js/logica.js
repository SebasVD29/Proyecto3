...
$("#crearCliente").click(function () {
    ...
    jQuery.ajax({
        type: 'post',
        url: "https://localhost:7088/api/choferesControllers?identificacion=" + identificacion + " &nombre=" + nombre + "&direccion=" + direccion + "&telefono=" + telefono + "&email=" + correo + + "&estado=" + estado + "",
        contentType: "application/json; charset=utf-8",
        cache: false,
        datatype: 'jsonp',
        traditional: true,
