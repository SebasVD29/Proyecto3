...
namespace API_Choferes.Controllers
{
    ...
    public class camionesControllers : ControllerBase
    {
        ...
        [HttpGet("{numeroPlaca}")]
        public string[] Get(string numeroPlaca)
        {
            ...
            try
            {
                ...
                using (SqlCommand comando = new SqlCommand(querySQL, this.conexion))
                {
                    using (SqlDataReader lector = comando.ExecuteReader())
                    {
                        while (lector.Read())
                        {
                            return new string[] { (string)lector["Marca"], (string)lector["Modelo"], (DateOnly)lector["Fabricacion"], (string)lector["Estado"] };
        ...
        [HttpPost]
        [EnableCors(origins: "*", methods: "*", headers: "*")]
        public void Post(string numeroPlaca, string Marca, string Modelo, DateOnly Fabricacion, string Estado)
        {
            ...
            try
            {
                ...
                using (SqlCommand comando = new SqlCommand(querySQL, this.conexion))
                {
                    ...
                    comando.Parameters.AddWithValue("Fabricacion", Fabricacion);
